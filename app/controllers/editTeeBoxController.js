(function () {
    ...
    var EditTeeBoxController = function ($scope, $window, $log, $routeParams, coursesFactory) {
        ...
        function init() {
            coursesFactory.getTee($routeParams.teeId)
...
//==========================================================================================
            coursesFactory.getTees($scope.course._id)                           /*  Step 1  */
                .error(function (data, status, headers, config) {
...
// if we make it here, the tee box name does not exist in the DB for this course for any other defined tee, and can be updated.
                    ...
                    coursesFactory.updateTee($scope.tee)                        /*  Step 4  */
                        ...
                        .error(function (data, status, headers, config) {
                            $log.error("Edit Round - error updating database: ", JSON.stringify({data: data}));
    ...
    EditTeeBoxController.$inject = ['$scope', '$window', '$log', '$routeParams', 'coursesFactory'];

    angular.module('golfApp')
        .controller('EditTeeBoxController', EditTeeBoxController);
